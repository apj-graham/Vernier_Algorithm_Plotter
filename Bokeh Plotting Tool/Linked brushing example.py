...
plot_options = dict(width=250, plot_height=250, tools="box_select, lasso_select, help, pan, wheel_zoom")

s1 = figure(**plot_options)
s1.line(x, y0, line_width=2, source=source)

s2 = figure(x_range=s1.x_range, y_range=s1.y_range, **plot_options)
s2.line(x, y0, line_width=2, source=source)
